...
1. [安装（作为 AI Agent Skill）](#安装作为-ai-agent-skill)
2. [基础用法](#基础用法)
3. [布局配置](#布局配置)
4. [Mermaid 图表处理](#mermaid-图表处理)
5. [内联格式](#内联格式)
6. [引述格式](#引述格式)
7. [高级示例](#高级示例)
8. [故障排除](#故障排除)

## 安装（作为 AI Agent Skill）
...
安装后，AI Agent（如 Claude Code）可在需要生成 PPT 时自动调用此工具。
